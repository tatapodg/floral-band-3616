...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-band-3616
```

A live public deployment of this template is available at [https://floral-band-3616.templates.workers.dev](https://floral-band-3616.templates.workers.dev)
